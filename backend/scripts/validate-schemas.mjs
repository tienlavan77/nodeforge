...
const fixtures = [
  ...
  ["https://forge.local/schemas/core/event.schema.json", "schemas/examples/event-agent-runtime.json"],
  ...
  ["https://forge.local/schemas/node/node-event.schema.json", "schemas/examples/event-agent-runtime.json"],
