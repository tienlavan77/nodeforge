...
export function buildUsageQuery({ taskId, stepId, unwiredFiles, parentId = null, projectId, conversationId, correlationId, instructionBlocks = [], userBlocks = [], cacheConfig, createRequestId = randomUUID, clock = () => new Date() } = {}) {
