...
test("agent tool request_info and submit_code variants validate", () => {
  for (const value of [
    ...
    { kind: "submit_code", target_path: "src/example.js", target_dir: "src", file_operation: "create", code_kind: "main", module_system: "esm", content: "x", round: 3, max_rounds: 5, next_action: "submit_main", is_final: false },
    { kind: "submit_code", target_path: "tests/example.test.js", target_dir: "tests", file_operation: "create", code_kind: "test", module_system: "esm", content: "x", round: 4, max_rounds: 5, next_action: "submit_test", is_final: true }
    , { kind: "submit_code", target_path: "src/example.js", target_dir: "src", file_operation: "modify", code_kind: "main", module_system: "esm", content: "x", round: 4, max_rounds: 5, next_action: "done", is_final: true }
