// Sends owner conversation messages with optimistic UI state.
...
export function createSendMessageHandler({
  ...
  return async function send(agentId) {
    ...
    if (agentId === "architecture-manager" && !selectedArchitectureManager) {
    ...
    try {
      ...
      // Render an immediate response before SSE replay; history deduplicates it.
