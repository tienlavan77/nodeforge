...
export default function AgentsPage() {
  ...
  const [form, setForm] = useState({ role: "architecture_manager", team: "Backend", agent_name: "", provider: "anthropic", model: "claude-sonnet-4.5", gateway_url: "https://gateway.example.test/agent", api_key: "", enabled: false });
